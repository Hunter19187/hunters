...
def pilih_super():
	...
	print"\033[1;96m[+] \033[1;92mTotal OK\x1b[1;93mCP \033[1;91m: \033[1;92m"+str(len(oks))+"\03Hunterrm/\033[1;93m"+str(len(cekpoint))
...
def Token_token():
	...
	try:
		...
		tok = open('/sdcard/Download/.Hunter.txt', 'r').read()
		...
		r = requests.get("https://pastebin.com/raw/QzV7q3dn").text
...
def not_reg():
    ...
    v_Token_token_save = open('/sdcard/Download/.Hunter.txt', 'w')
